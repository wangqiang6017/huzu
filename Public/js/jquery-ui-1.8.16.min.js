    ...
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _updateVirtualBoundaries: function (e) {
            ...
            h = {
                ...
                maxHeight: c(h.maxHeight) ? h.maxHeight :
                    Infinity
            };
...
(function (a) {
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _refreshItems: function (d) {
            ...
            var c = this.items, e = [[a.isFunction(this.options.items) ? this.options.items.call(this.element[0], d, {item: this.currentItem}) : a(this.options.items, this.element),
...
jQuery.effects || function (a, d) {
    ...
    a.effects.animateClass = function (n, k, m,
        ...
        return this.queue(function () {
            ...
            q.attr("class", v);
            q.animate(i(r, u), {
                queue: false, duration: k, easing: m, complete: function () {
                    a.each(l, function (w, x) {
                        n[x] && q[x + "Class"](n[x])
                    });
    ...
    a.fn.extend({
        _addClass: a.fn.addClass, addClass: function (n, k, m, p) {
    ...
    a.extend(a.effects, {
        version: "1.8.16", save: function (n, k) {
    ...
    a.extend(a.easing, {
        def: "easeOutQuad", swing: function (n, k, m, p, q) {
    ...
    a.effects.puff = function (d) {
        return this.queue(function () {
            ...
            a.extend(d.options, {
                ...
                from: e == "hide" ? i : {height: i.height * g, width: i.width * g}
            });
    ...
    a.effects.size = function (d) {
        return this.queue(function () {
            var c = a(this), e = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"], h = ["position", "top", "bottom", "left", "right", "overflow", "opacity"], g = ["width", "height", "overflow"], i = ["fontSize"], b = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], f = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
                j = a.effects.setMode(c, d.options.mode || "effect"), l = d.options.restore || false, o = d.options.scale || "both", n = d.options.origin, k = {
                    height: c.height(),
                    width: c.width()
                };
            ...
            var m = {
                from: {y: c.from.height / k.height, x: c.from.width / k.width},
                to: {y: c.to.height / k.height, x: c.to.width / k.width}
            };
            if (o == "box" || o == "both") {
                if (m.from.y != m.to.y) {
                    e = e.concat(b);
        ...
        options: {
            ...
            if (a.isArray(this.options.source)) {
                ...
                this.source = function (g, i) {
                    c.xhr && c.xhr.abort();
                    c.xhr = a.ajax({
                        url: h, data: g, dataType: "json", autocompleteRequest: ++d, success: function (b) {
...
(function (a, d) {
    var c = {
        ...
        minWidth: true,
        width: true
    }, e = {maxHeight: true, maxWidth: true, minHeight: true, minWidth: true}, h = a.attrFn || {
            val: true,
            css: true,
            html: true,
            text: true,
    ...
    a.widget("ui.dialog", {
        options: {
            ...
            modal: false,
            position: {
                my: "center", at: "center", collision: "fit", using: function (g) {
            ...
            var g = this, i = g.options, b = i.title || "&#160;", f = a.ui.dialog.getTitleId(g.element), j = (g.uiDialog = a("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " +
                i.dialogClass).css({zIndex: i.zIndex}).attr("tabIndex", -1).css("outline", 0).keydown(function (n) {
    ...
    a.extend(a.ui.dialog, {
        version: "1.8.16", uuid: 0, maxZ: 0, getTitleId: function (g) {
            g = g.attr("id");
            if (!g) {
                this.uuid += 1;
                g = this.uuid
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)this.handles.each(function (o) {
                ...
                if (e.options.range === true)if (e.orientation === "horizontal") {
                    ...
                    if (o === 1)e.range[h ? "animate" : "css"]({height: g - b + "%"}, {
                        queue: false,
                        duration: c.animate
                    })
                }
                ...
                if (d === "min" && this.orientation === "horizontal")this.range.stop(1, 1)[h ? "animate" : "css"]({width: g + "%"},
                    c.animate);
                if (d === "max" && this.orientation === "horizontal")this.range[h ? "animate" : "css"]({width: 100 - g + "%"}, {
                    queue: false,
                    duration: c.animate
                });
                if (d === "min" && this.orientation === "vertical")this.range.stop(1, 1)[h ? "animate" : "css"]({height: g + "%"}, c.animate);
                if (d === "max" && this.orientation === "vertical")this.range[h ? "animate" : "css"]({height: 100 - g + "%"}, {
                    queue: false,
                    duration: c.animate
                })
            }
