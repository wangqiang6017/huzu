                                    ...
                                    <div class="portlet-body form-horizontal">
                                        <div>
                                            <table class="table table-bordered table-striped example cus_datatable dataTable no-footer" cellspacing="0" id="ContentPlaceHolder1_GridView1_DetailsView1" style="border-collapse:collapse;">
                                                ...
                                                <div class="control-group">
                                                    <div class="controls input-icon">
                                                        <input name="min_direct" type="text" id="min_direct" class="form-control" />
                                                    </div>
                                                </div>
                                            </td>
                                            </tr><tr>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls input-icon">
                                                        <input name="max_direct" type="text" id="max_direct" class="form-control" />
                                                    </div>
                                                </div>
                                            </td>
                                            </tr>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls input-icon">
                                                        <input name="min_team" type="text" id="min_team" class="form-control" />
                                                    </div>
                                                </div>
                                            </td>
                                            </tr><tr>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls input-icon">
                                                        <input name="max_team" type="text" id="max_team" class="form-control" />
                                                    </div>
                                                </div>
                                            </td>
                                            </tr><tr>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls input-icon">
                                                        <input name="interest" type="text" id="interest" class="form-control" />
                                                    </div>
                                                    <div class="help-hint">
                                                        (请填写小数，如0.01会自动转换为1%)
                                                    </div>
                                                ...
                                                <td colspan="2">
                                                    <a onclick="doSubmit()" class="btn" href="javascript:void(0);">添加</a>
...
<script type="text/javascript">
    function doSubmit() {
        $.post('/user/levelAdd',$("#loginForm").serialize(),function(data){
            if(data.ret){
                alert('操作成功');
