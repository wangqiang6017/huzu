        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="portlet-body flip-scroll">
                    <div>
                        <div class="span10"><a href="/user/levelAdd/">添加会员级别</a></div>
                        <table class="table table-bordered table-striped example cus_datatable dataTable no-footer" cellspacing="0" id="ContentPlaceHolder1_GridView1" style="border-collapse:collapse;">
                            <tr>
                                ...
                                <th scope="col">最小直推人数</th>
                                <th scope="col">最大直推人数</th>
                                <th scope="col">最小团队人数</th>
                                <th scope="col">最大团队人数</th>
                                <th scope="col">利息</th>
                                <th scope="col">操作</th>
                            </tr>
                            ...
                            <td><?php echo ($v["min_direct"]); ?>人</td>
                            <td><?php echo ($v["max_direct"]); ?>人</td>
                            <td><?php echo ($v["min_team"]); ?>人</td>
                            <td><?php echo ($v["max_team"]); ?>人</td>
                            <td><?php echo ($v["interest"]); ?>%</td>
                            <td>
                            <a href="/user/levelEdit/id/<?php echo ($v["id"]); ?>">编辑</a>
                            &nbsp;<a onclick="del(<?php echo ($v["id"]); ?>)" href="javascript:void(0);" >删除</a>
                            </td>
                        </tr>
                        <?php }} ?>
                        </table>
...
<script type="text/javascript">
    function del(id)
    {
        if (confirm('确定要删除吗？'))
        {
            $.post('/user/levelDel/id/' + id, function(data){
                if (data.ret)
                {
                    alert('删除成功');
